...
{
    /// <inheritdoc />
    public partial class AddIdentityAndUserSlips : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumbersJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserActivityHistories_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Slips_UserId_CreatedAt",
                table: "Slips",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Slips_UserId_IsFavorite",
                table: "Slips",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivityHistories_GameId",
                table: "UserActivityHistories",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActivityHistories_UserId_CreatedAt",
                table: "UserActivityHistories",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.AddForeignKey(
                name: "FK_Slips_AspNetUsers_UserId",
                table: "Slips",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
